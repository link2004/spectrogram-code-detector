...
BANDWIDTH = 1000  # バンド幅
DOWNSAMPLE_RATE = 1  # ダウンサンプリングレート
SAMPLE_RATE = 44100   # サンプリングレート
BUFFER_SIZE = int(1000 * SAMPLE_RATE / (1000 * DOWNSAMPLE_RATE))  # バッファサイズ
...
def audio_callback(indata, frames, time, status):
    ...
    plotdata_multiply[-shift:] = filtered_data * plotdata_delay[BUFFER_SIZE-shift:BUFFER_SIZE] * 2
